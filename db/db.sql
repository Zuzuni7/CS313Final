...
INSERT INTO users_ (username,pw,prefered_name) VALUES ('admin', 'password', 'Admin');
INSERT INTO users_ (username,pw,prefered_name) VALUES ('test', 'test', 'test');
...
-- d6h6qif4cicgvo Database name
-- USername   vmbubwrksilkgw